...
{ 
  ...
  duration = pulseIn(echoPin1, HIGH, 5000);// here this pulsein function wont wait more then 5000us for the ultrasonic sound to came back. (due to this it wont measure more than 60cm)
                                           ...
                                           // so that, it will return zero if distance greater then 60cm. ( it helps usually if we remove our hands infront of the sensors ).
...
void loop()
{
  ...
  { 
    ...
    {
    Serial.println("change");            // send "previous" serially.
